...
class ApplicationConfiguration(DeviceConfiguration[ThirdPartyDevice]):
    ...
    DEFAULT_SERVER_BASE_PORT: str = __SCHEMA_PROPERTIES["server_base_port"]["default"]
    ...
    def _parse(self) -> None:
        try:
            with open(self._file_path, "r") as config_file:
                ...
                self.__server_base_port = config.get("server_base_port", self.DEFAULT_SERVER_BASE_PORT)
    ...
    @property
    def server_base_port(self) -> str:
        return self.__server_base_port

    @server_base_port.setter
    def server_base_port(self, server_base_port: str):
        """
